...
aut aut aut maxime quia temporibus ut omnis`}],Nc=[{id:1,name:"Leanne Graham",username:"Bret",email:"Sincere@april.biz"},{id:2,name:"Ervin Howell",username:"Antonette",email:"Shanna@melissa.tv"},{id:3,name:"Clementine Bauch",username:"Samantha",email:"Nathan@yesenia.net"},{id:4,name:"Patricia Lebsack",username:"Karianne",email:"Julianne.OConner@kory.org"},{id:5,name:"Chelsey Dietrich",username:"Kamren",email:"Lucio_Hettinger@annie.ca"},{id:6,name:"Mrs. Dennis Schulist",username:"Leopoldo_Corkery",email:"Karley_Dach@jasper.info"},{id:7,name:"Kurtis Weissnat",username:"Elwyn.Skiles",email:"Telly.Hoeger@billy.biz"},{id:8,name:"Nicholas Runolfsdottir V",username:"Maxime_Nienow",email:"Sherwood@rosamond.me"},{id:9,name:"Glenna Reichert",username:"Delphine",email:"Chaim_McDermott@dana.io"},{id:10,name:"Clementina DuBuque",username:"Moriah.Stanton",email:"Rey.Padberg@karina.biz"}],Pc=({comment:e})=>j.jsxs("div",{className:"CommentInfo",children:[j.jsxs("div",{className:"CommentInfo__title",children:[j.jsx("strong",{className:"CommentInfo__name",children:e.name})," by ",j.jsx("a",{className:"CommentInfo__email",href:`mailto:${e.email}`,children:e.email})]}),j.jsx("div",{className:"CommentInfo__body",children:e.body})]}),Lc=({comments:e})=>!Array.isArray(e)||e.length===0?j.jsx("b",{"data-cy":"NoCommentsMessage",children:"No comments yet"}):j.jsx(j.Fragment,{children:e.map(t=>j.jsx(Pc,{comment:t},t.id))}),Tc=({user:e})=>j.jsx("a",{className:"UserInfo",href:`mailto:${e.email}`,children:e.name}),Mc=({post:e})=>j.jsxs("div",{className:"PostInfo",children:[j.jsxs("div",{className:"PostInfo__header",children:[j.jsx("h3",{className:"PostInfo__title",children:e.title}),j.jsxs("p",{children:[" Posted by  ",j.jsx(Tc,{user:e.user})]})]}),j.jsx("p",{className:"PostInfo__body",children:e.body}),j.jsx("hr",{}),j.jsx(Lc,{comments:e.comments})]}),Rc=({posts:e})=>j.jsx("div",{className:"PostList",children:e.map(t=>j.jsx(Mc,{post:t},t.id))});function Dc(e){return Nc.find(t=>t.id===e||null)}function jc(e){return zc.filter(t=>t.postId===e||null)}const Oc=Cc.map(e=>({...e,user:Dc(e.userId),comments:jc(e.id)})),Fc=()=>j.jsxs("section",{className:"App",children:[j.jsx("h1",{className:"App__title",children:"Static list of posts"}),j.jsx(Rc,{posts:Oc})]});em(document.getElementById("root")).render(j.jsx(Fc,{}));
